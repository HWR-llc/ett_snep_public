  ...
  <div>
    <div class="row" id="topRow">
      <div class="col-2" id="logoBox">
          ...
          <router-link to="/"><img src="../assets/logos/ett_snep_square_no_border.svg" style="background-color: white; max-width: 100%; max-height: 180px; margin: auto; display: block; padding-top: 5px" alt="ETT-SNEP logo"></router-link>
      </div>
