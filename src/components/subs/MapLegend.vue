<template>
  <div class="legend-border">
    <div class="row">
      ...
      <div class="col-9">
        ETT Assessment Areas - Tidally Influenced
      </div>
    </div>
    <div class="row">
      <div class="col-3">
        <svg height="20" width="30">
          <rect id="legend 2" x="0" y="0" width="30" height="20" style="fill: #808080; fill-opacity: 0.5; ; stroke: #d3d3d3"/>
        </svg> 
      </div>
      <div class="col-9">
        SNEP Area Beyond Tidal Influence
      </div>
    </div>
    <div class="row">
      <div class="col-3">
        <svg height="20" width="30">
          <rect id="legend 2" x="0" y="0" width="30" height="20" style="fill: #000000; fill-opacity: 0; stroke-width: 3; stroke: #006400"/>
        </svg> 
      </div>
      <div class="col-9">
        SNEP Region
    ...
    <div v-for="(item, key) in imageLibraryHabitat" :key="key">
      <div v-if="habitat == key">
        <div class="row">
          <div class="col-3">
            <svg height="20" width="30">
              <rect id="legend 4" x="0" y="0" width="30" height="20" :style="{fill: item.currentColor}"/>
            </svg> 
          </div>
          <div class="col-9">
            {{ item.title }} Extent
